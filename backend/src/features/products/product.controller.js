...
const getAllProducts = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to fetch products", errors: [] });
  }
};
...
const getProductById = async (req, res) => {
  try {
    ...
    res.status(200).json({ success: true, message: null, data: serializeProduct(product) });
  } catch (error) {
    console.error("getProductById error:", error);
    res.status(500).json({ success: false, message: "Failed to fetch product", errors: [] });
  }
};
...
const filterProducts = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to filter products", errors: [] });
  }
};
...
const getProductsByCategory = async (req, res) => {
  try {
    ...
    res.status(200).json({ success: true, message: null, data: products.map(serializeProduct) });
  } catch (error) {
    console.error("getProductsByCategory error:", error);
    res.status(500).json({ success: false, message: "Failed to fetch products by category", errors: [] });
  }
};
...
const getProductsByBrand = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to fetch products by brand", errors: [] });
  }
};
...
const createProduct = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to create product", errors: [] });
  }
};
...
const updateProduct = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to update product", errors: [] });
  }
};
...
const deleteProduct = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to delete product", errors: [] });
  }
};
