...
export default function Testimonials({ testimonials = [] }) {
  ...
  return (
    <div className="w-full overflow-visible">
      ...
      {/* DESKTOP — 3 cards, continuous loop, clean arrows */}
      <div className="hidden md:block relative px-12">
        {/* Left arrow — clean, no circle */}
        <button
          ref={prevRef}
          className="absolute left-0 top-1/2 -translate-y-1/2 z-10 flex items-center justify-center text-gray-300 hover:text-[#76CDD6] transition-all duration-300 group cursor-pointer bg-transparent border-none"
          aria-label="Previous"
        ...
        {/* Right arrow — clean, no circle */}
        <button
          ref={nextRef}
          className="absolute right-0 top-1/2 -translate-y-1/2 z-10 flex items-center justify-center text-gray-300 hover:text-[#76CDD6] transition-all duration-300 group cursor-pointer bg-transparent border-none"
          aria-label="Next"
          style={{ background: 'none' }}
        >
          <svg 
