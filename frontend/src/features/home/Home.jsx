...
const SCAN_STATES = [
  {
    id: 0,
    headline: "Try frames on",
    accent: "your face. Live.",
    subline: "Turn on your camera — see how any frame looks on you in real time. No app, no guesswork.",
    accentColor: "#76CDD6",
    textColor: "#1E1D22",
  ...
  {
    id: 1,
    headline: "Your face shape,",
    accent: "your perfect frame.",
    subline: "Upload a selfie. Our AI reads your facial geometry and recommends frames built for your features.",
    accentColor: "#76CDD6",
    textColor: "#FFFFFF",
  ...
  },
  {
    ...
    accent: "who need precision.",
    subline: "Prescription wearers deserve to see the fit before they commit. Now you can.",
    accentColor: "#1E1D22",
    textColor: "#1E1D22",
  ...
  },
  {
    ...
    accent: "for your eyes.",
    subline: "Smart recommendations, real-time try-on, zero compromise. Eyewear shopping, reimagined.",
    accentColor: "#76CDD6",
    textColor: "#FFFFFF",
