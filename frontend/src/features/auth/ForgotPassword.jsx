        ...
        <div className="w-full max-w-sm mx-auto relative z-10">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-light tracking-tight text-gray-900 mb-2">
              Reset <span className="font-serif italic font-normal text-black block md:inline">password.</span>
            </h1>
          ...
          {!submitted ? (
            ...
            <div className="py-6">
              ...
              <p className="text-sm font-light text-gray-500 leading-relaxed">
                If <span className="text-gray-900 font-medium">{email}</span> exists in our system, you'll receive a reset link shortly.
              </p>
            </div>
          )}
