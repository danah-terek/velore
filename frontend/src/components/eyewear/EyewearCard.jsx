  ...
  return (
    <div className="bg-blue-100 rounded-sm relative flex flex-col w-full">
      ...
      <div className="px-3 md:px-4 mb-3 md:mb-4">
        ...
        <p className="text-xs md:text-sm font-semibold text-gray-900 mb-1">${price}</p>
      ...
      <div className="flex items-center gap-2 px-3 md:px-4 pb-3 md:pb-4 mt-auto">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 md:w-6 md:h-6" fill={favorited ? 'red' : 'none'} viewBox="0 0 24 24" stroke={favorited ? 'red' : 'currentColor'}>
